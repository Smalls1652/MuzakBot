...
public partial class AlbumReleaseCommandModule
{
    ...
    /// </remarks>
    [ComponentInteraction(customId: "remove-albumrelease-post-btn-*", true)]
    private async Task HandleMusicShareMessageRemovalAsync()
    {
        ...
        _logger.LogInformation("Removing message '{id}'. Initiated by '{username}'", originalResponse.Id, Context.User.Username);
