...
public partial class AdminCommandModule : InteractionModuleBase<SocketInteractionContext>, IDisposable
{
    ...
    public AdminCommandModule(IDbContextFactory<LyricsAnalyzerContext> lyricsAnalyzerContextFactory, IHttpClientFactory httpClientFactory, ILogger<AdminCommandModule> logger, DiscordSocketClient discordSocketClient)
    {
